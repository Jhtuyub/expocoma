...
namespace EXPOCOMA.Stand
{
    public partial class FrmIndex : Form
    {
        ...
        public void Tablas()
        {
            ...
            String _dbfAgentes = "IF OBJECT_ID('dbf_agentes') IS NULL "
                + "CREATE TABLE[dbf_agentes] ("
                + "[id][int] IDENTITY(1, 1) NOT NULL,"
                + "[ID_SUCURSALALM][varchar](5) NOT NULL,"
                + "[C_AGENTE][VARCHAR](3) NULL,"
                + "[NOM_AGENTE]    [varchar](30) NULL,"
                + "[PLA_AGENTE]    [varchar](3) NULL,"
                + "[COMI_POR]  [NUMERIC](3,0) NULL,"
                + "[COMPA_AGE] [varchar](3) NULL,"
                + "[AG_STAT]   [varchar](1) NULL,"
                + "[CUOTA_DIA] [NUMERIC](8,2) NULL,"
                + "[AG_ZONA]   [varchar](1) NULL,"
                + "[SERIE] [varchar](2) NULL,"
                + "[TODCOB]    [varchar](1) NULL,"
                + "[SECCION]   [NUMERIC](2,0) NULL,"
                + "[ULTFOL]    [NUMERIC](5,0) NULL,"
                + "[CLAVE] [varchar](5) NULL,"
                + "[CVE_PER]   [varchar](6) NULL,"
                + "[HORA_ACT]  [varchar](5) NULL,"
                + "[FECHA_ACT][datetime] NULL,"
                + "[SUPERVISOR]    [varchar](3) NULL,"
                + "[GRUPO] [NUMERIC](2,0) NULL,"
                + "[ID_USUARIO]    [varchar](15) NULL,"
                + "[ID_HORA]   [varchar](5) NULL,"
                + "[ID_FECHA][datetime] NULL,"
                + "[COMFIJA]   [NUMERIC](9,2) NULL,"
                + "[PORFIJO]   [NUMERIC](5,2) NULL,"
                + "[AUTORIZADO]    [varchar](15) NULL,"
                + "[FALTANTE]  [varchar](5) NULL,"
                + "[CVE_PERX]  [varchar](4) NULL,"
                + "[CLAVE2]    [varchar](5) NULL,"
                + "[ORACLE][datetime] NULL,"
                + "[CORREO]    [varchar](35) NULL,"
                + "[MESSENGER] [varchar](35) NULL,"
                + "[AC1MARCA]  [varchar](30) NULL,"
                + "[AC1SERIE]  [varchar](15) NULL,"
                + "[AC2MARCA]  [varchar](30) NULL,"
                + "[AC2SERIE]  [varchar](15) NULL,"
                + "[AC3MARCA]  [varchar](30) NULL,"
                + "[AC3SERIE]  [varchar](15) NULL,"
                + "[AC4MARCA]  [varchar](30) NULL,"
                + "[AC4SERIE]  [varchar](15) NULL,"
                + "[AC5MARCA]  [varchar](30) NULL,"
                + "[AC5SERIE]  [varchar](15) NULL,"
                + "[PMARCA]    [varchar](30) NULL,"
                + "[PSERIE]    [varchar](15) NULL,"
                + "[IMARCA]    [varchar](30) NULL,"
                + "[ISERIE]    [varchar](15) NULL,"
                + "[MMARCA]    [varchar](30) NULL,"
                + "[MSERIE]    [varchar](15) NULL,"
                + "[NO_CTES]   [NUMERIC](8,0) NULL,"
                + "[HORA_LIQ]  [varchar](5) NULL,"
                + "[FECHA_LIQ][datetime] NULL,"
                + "[HORA_PAS]  [varchar](5) NULL,"
                + "[FECHA_PAS][datetime] NULL,"
                + "[GPRS]  [varchar](1) NULL,"
                + "[BLUETOOTH] [varchar](1) NULL,"
                + "[FEC_LIQ_C][datetime] NULL,"
                + "[HO_LIQ_C]  [varchar](5) NULL,"
                + "[ULTFOL_CG] [NUMERIC](5,0) NULL,"
                + "[FALTASOFOM]    [varchar](5) NULL"
                + ");";

            String _dbfRutagen = "IF OBJECT_ID('dbf_rutagen') IS NULL "
                + "CREATE TABLE[dbf_rutagen] ("
                + "[id][int] IDENTITY(1, 1) NOT NULL,"
                + "[ID_SUCURSALALM][varchar](5) NOT NULL,"
                + "[C_AGENTE]  [varchar](3) NULL,"
                + "[C_RUTA]    [varchar](2) NULL"
            ...
            String _dbfRutas = "IF OBJECT_ID('dbf_rutas') IS NULL "
                + "CREATE TABLE[dbf_rutas] ("
                + "[id][int] IDENTITY(1, 1) NOT NULL,"
                + "[ID_SUCURSALALM][varchar](5) NOT NULL,"
                ...
                + "[TIPO]  [varchar](1) NULL,"
                + "[CUOTA_DIA] [NUMERIC](8,2) NULL,"
                + "[PLA_RUTA]  [varchar](3) NULL,"
                + "[FLETE] [varchar](1) NULL,"
                + "[ORDENADO]  [varchar](1) NULL,"
                + "[MINRUT]    [varchar](1) NULL,"
                + "[QUINTANA][bit]NOT NULL DEFAULT 0,"
                + "[FLETE2]    [NUMERIC](5,2) NULL,"
                + "[FLECAJ]    [NUMERIC](5,2) NULL,"
                + "[ESPECIAL]  [varchar](1) NULL,"
                + "[DIAS_ENT]  [NUMERIC](2,0) NULL,"
                + "[DOLLAR]    [varchar](1) NULL,"
                + "[C_P]   [NUMERIC](4,0) NULL,"
                ...
                + "[ID_USUARIO]    [varchar](15) NULL,"
                + "[ID_FECHA][datetime] NULL,"
                + "[ID_TIME]   [varchar](5) NULL,"
                + "[ID_HORA]	[varchar](5),"
                + "[VIRTUAL][bit]NOT NULL DEFAULT 0,"
                + "[CLVSUC]    [varchar](3) NULL,"
                + "[NO_INCLU][bit]NOT NULL DEFAULT 0,"
                +"[ABORDO]    [bit]NOT NULL DEFAULT 0,"
                + "[UTIL_OBJ]  [NUMERIC](12,2) NULL,"
                + "[MARG_OBJ]  [NUMERIC](5,2) NULL,"
                + "[RUT_ESP][bit]NOT NULL DEFAULT 0,"
                + "[ORACLE][datetime] NULL,"
                + "[VAL_DES]   [varchar](1) NULL,"
                + "[PVAL_DES]  [NUMERIC](6,2) NULL,"
                + "[TAR_CRE]   [varchar](1) NULL,"
                + "[PTAR_CRE]  [NUMERIC](6,2) NULL,"
                + "[MIN_VTA]   [NUMERIC](10,2) NULL,"
                + "[COSACOS][bit]NOT NULL DEFAULT 0,"
                + "[WILLYS][bit]NOT NULL DEFAULT 0,"
